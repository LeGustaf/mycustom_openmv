...
# Compiler Flags
CFLAGS += -std=gnu99 -Wall -Wno-error -Wno-nonnull-compare -Wno-unused-function -Warray-bounds -mthumb -nostartfiles -fdata-sections -ffunction-sections
...
FIRM_OBJ += $(addprefix $(BUILD)/$(MICROPY_DIR)/modules/ECC/,\
	crypto/bignum.o                  	\
	crypto/ecdsa.o                  	\
	crypto/hmac.o                  		\
	crypto/memzero.o                  	\
...
FIRM_OBJ += $(addprefix $(BUILD)/$(MICROPY_DIR)/modules/SECP256K1/,\
	secp256k1/src/utility/secp256k1.o  	   	\
	libsecp256k1.o							\
	)
endif

ifeq ($(MICROPY_PY_UQR), 1)
FIRM_OBJ += $(addprefix $(BUILD)/$(MICROPY_DIR)/modules/UQR/,\
	moduqr.o                  				\
	qrcodegen.o                         	\
	)
endif
...
FIRM_OBJ += $(addprefix $(BUILD)/$(MICROPY_DIR)/modules/NEW_MODULE/,\
	newmodule.o                  			\
	NEW_MOD_DEPS/code1.o                   	\
	NEW_MOD_DEPS/code2.o                   	\
	)
endif
